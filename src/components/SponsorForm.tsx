...
const tiers = [
  ...
  { icon: Gem, name: "Золото", price: "от 700 000 ₽", perks: ["Всё из Серебра", "Стенд 9 м²", "5 билетов", "Выступление 15 мин"] },
  { icon: Crown, name: "Платина", price: "от 1 500 000 ₽", perks: ["Всё из Золота", "Стенд 25 м²", "10 билетов", "Пленарный доклад"] },
];
